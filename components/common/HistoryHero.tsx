// components/common/HistoryHero.tsx
"use client";

import { useTranslations } from "next-intl";

export default function HistoryHero() {
  const t = useTranslations("History.hero");
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-2 right-2 z-20 text-[10px] text-white/70">
        Foto de{" "}
        <a 
          href="https://unsplash.com/es/@victorhwn725?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
        ...
        {" en "}
        <a 
          href="https://unsplash.com/es/fotos/vista-aerea-de-montanas-verdes-durante-el-dia-yam1KMv0SgQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-white"
        >

// components/common/GastronomyHero.tsx
"use client";

import { useTranslations } from "next-intl";

export default function GastronomyHero() {
  const t = useTranslations("Gastronomy.hero");
  ...
  return (
    <section
      className="
        ...
        min-h-[600px]
        w-full
        bg-[url('/img/hero-gastronomia.jpg')]
        bg-cover
        bg-center
        bg-fixed
      "
    >
      ...
      <div className="absolute bottom-2 right-2 z-20 text-[10px] text-white/70">
        Foto de{" "}
        <a 
          href="https://unsplash.com/es/@hmauriciog?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
        ...
        {" en "}
        <a 
          href="https://unsplash.com/es/fotos/una-mesa-de-madera-cubierta-con-cuencos-llenos-de-comida-ZeQwbjfgmD4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-white"
        >

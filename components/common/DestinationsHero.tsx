// components/common/DestinationsHero.tsx
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-2 right-2 z-20 text-[10px] text-white/70">
        Foto de{" "}
        <a 
          href="https://unsplash.com/es/@xapalacioscx?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
        ...
        {" en "}
        <a 
          href="https://unsplash.com/es/fotos/personas-que-caminan-por-la-calle-durante-el-dia-FxmD64oK3wU?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-white"
        >

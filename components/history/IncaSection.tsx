...
const TIMELINE_IDS = ["origins", "pachacutec", "expansion", "crisis"] as const;
const STRUCTURE_IDS = [
  "territory",
  "government",
  "roads",
...
export default function IncaSection() {
  const t = useTranslations("History.inca");
    ...
    >
      <div className="mx-auto max-w-6xl space-y-10 px-4">
        ...
        <header className="text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-sm text-zinc-700 md:text-base">
            {t("subtitle")}
          </p>
        ...
        <section className="rounded-2xl border border-sky-100 bg-white p-6 shadow-sm md:p-7">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-4">
            {TIMELINE_IDS.map((id) => (
              <article
                key={id}
                className="rounded-xl bg-sky-50/70 p-4 text-sm text-zinc-800"
              >
        ...
        {/* BLOQUE 3: CÓMO FUNCIONABA EL IMPERIO */}
        <section className="rounded-2xl border border-sky-100 bg-white p-6 shadow-sm md:p-7">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-sky-800">
            {t("structure.title")}
          </h3>
        ...
        <section className="rounded-2xl border border-sky-100 bg-white p-6 shadow-sm md:p-7">
          ...
          <div className="mt-4 grid gap-6 md:grid-cols-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-sky-900">
                {t("life.festivals.title")}
              </p>
              <p className="mt-2 text-sm text-zinc-700 md:text-base">
                {t("life.festivals.text")}
              </p>
            </div>
          </div>
        </section>

        {/* BLOQUE 5: LUGARES PARA VER HOY */}
        <section className="rounded-2xl border border-sky-100 bg-white p-6 shadow-sm md:p-7">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-sky-800">
            {t("sites.title")}
          </h3>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            {SITE_IDS.map((id) => (
              <article
                key={id}
                className="flex flex-col justify-between gap-2 rounded-xl bg-sky-50/70 p-4 text-sm"
              >
                <div>
        ...
        {/* BLOQUE 6: TIPS PARA EXPLICAR EL TEMA */}
